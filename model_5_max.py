...
class Max5Model(nn.Module):
    def __init__(self):
        super(Max5Model, self).__init__()
        ...
        self.deconvMax3 = nn.ConvTranspose2d(in_channels=128, out_channels=64, kernel_size=2, stride=2, padding=1)
...
if __name__ == "__main__":
    m = Max5Model()
    summary(m, input_size=[(1, 96, 96), (60, 100, 100)],
            device="cpu")
"""
----------------------------------------------------------------
        Layer (type)               Output Shape         Param #
================================================================
            Conv2d-1           [-1, 64, 95, 95]             320
       BatchNorm2d-2           [-1, 64, 95, 95]             128
              ReLU-3           [-1, 64, 95, 95]               0
         MaxPool2d-4           [-1, 64, 47, 47]               0
            Conv2d-5          [-1, 128, 46, 46]          32,896
  ...
  ConvTranspose2d-28           [-1, 64, 96, 96]          32,832
      BatchNorm2d-29           [-1, 64, 96, 96]             128
             ReLU-30           [-1, 64, 96, 96]               0
  ConvTranspose2d-31            [-1, 1, 96, 96]              65
================================================================
Total params: 2,064,641
Trainable params: 2,064,641
Non-trainable params: 0
----------------------------------------------------------------
Input size (MB): 21093.75
Forward/backward pass size (MB): 61.50
Params size (MB): 7.88
Estimated Total Size (MB): 21163.12
----------------------------------------------------------------
"""
